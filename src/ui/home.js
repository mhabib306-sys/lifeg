...
export function renderHomeWidget(widget, isEditing) {
  ...
  const editControls = isEditing ? `
    <div class="flex items-center gap-1 ml-auto">
      ...
      ${isPerspectiveWidget ? `
        <button onclick="event.stopPropagation(); removePerspectiveWidget('${widget.id}')" class="widget-hide-btn p-1.5 text-[var(--text-muted)] hover:text-[var(--danger)] hover:bg-[color-mix(in_srgb,var(--danger)_8%,transparent)] rounded-md transition" title="Remove widget">
      ...
      ` : `
        <button onclick="event.stopPropagation(); toggleWidgetVisibility('${widget.id}')" class="widget-hide-btn p-1.5 text-[var(--text-muted)] hover:text-[var(--danger)] hover:bg-[color-mix(in_srgb,var(--danger)_8%,transparent)] rounded-md transition" title="Hide widget">
