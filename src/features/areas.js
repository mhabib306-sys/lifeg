...
export function updateArea(areaId, updates) {
  ...
  if (idx !== -1) {
    state.taskAreas[idx] = { ...state.taskAreas[idx], ...updates, updatedAt: new Date().toISOString() };
    saveTasksData();
  }
}
...
export function updateLabel(labelId, updates) {
  ...
  if (idx !== -1) {
    state.taskLabels[idx] = { ...state.taskLabels[idx], ...updates, updatedAt: new Date().toISOString() };
    saveTasksData();
  }
}
...
export function updatePerson(personId, updates) {
  ...
  if (idx !== -1) {
    state.taskPeople[idx] = { ...state.taskPeople[idx], ...updates, updatedAt: new Date().toISOString() };
    saveTasksData();
  }
}
