...
import {
  ...
  deleteNote, deleteNoteWithUndo, toggleNoteTask, focusNote, handleNoteKeydown, handleNoteBlur, handleNoteFocus,
  handleNoteInput, handleNotePaste, removeNoteInlineMeta,
...
import {
  ...
  updateEmojiGrid, toggleEmojiPicker,
...
const stateProxies = [
  ...
  'pendingPerspectiveEmoji', 'pendingAreaEmoji', 'pendingCategoryEmoji',
  ...
  'reviewMode', 'reviewAreaIndex', 'reviewCompletedAreas', 'reviewTriggersCollapsed', 'reviewProjectsCollapsed', 'reviewNotesCollapsed', 'lastWeeklyReview', 'lastSomedayReview',
