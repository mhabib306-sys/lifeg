...
│   │   ├── task-modal.js       (modal HTML, save/close, inline + modal autocomplete)
...
- When adding new functions that need to be called from onclick handlers, add them to `bridge.js`
